...
import com.br.audiobeatapi.exception.FileException;
...
public class ExcelMapper {
    ...
    public List<PayloadExcelDto> readFile(@Nonnull MultipartFile multipartFile) throws IOException {
        ...
        try {
            ...
            throw new FileException("Problemas com o arquivo");
        } finally {
            if (workbook != null) {
                workbook.close();
            }
    ...
    private void validaArquivo(MultipartFile multipartFile) {
        ...
        if (!extensions.equals("xlsx")) {
            throw new FileException("Arquivo invalido");
